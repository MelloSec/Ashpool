...
# try with and without the -n, -n was an issue on container
nmap -n -sn $cidr -oX alive
nmap -Pn -sn $cidr -oX alive-pn
...
nmap -sV -sC -p- -iL alive.txt -oX services -d --stats-every 30s --max-retries 2 --min-rate 100
...
nmap -n -sV --script "ftp-*" -p21 -iL ftp.txt -o enum-ftp.txt -d --stats-every 30s --max-retries 2 --min-rate 100
...
nmap -n -sV --script "smtp-*" -iL smtp.txt -o enum-smtp.txt -d --stats-every 30s --max-retries 2 --min-rate 100
...
nmap -n -sV --script "snmp-*" -iL snmp.txt -o enum-snmp.txt -d --stats-every 30s --max-retries 2 --min-rate 100
...
nmap -n -sV --script "telnet-*" -p23 -iL telnet.txt -o enum-telnet.txt -d --stats-every 30s --max-retries 2 --min-rate 100
$telnet = cat enum-telnet.txt; $telnet >> enum-all.txt

# Enumerate MYSQL
nmap -n -sV --script "mysql-*" -iL alive.txt -o enum-mysql.txt -d --stats-every 30s --max-retries 2 --min-rate 100
$mysql = cat enum-mysql.txt; $mysql >> enum-all.txt

# Enumerate MSSQL
nmap -n -sV --script "ms-sql-*" -iL alive.txt -o enum-mssql.txt -d --stats-every 30s --max-retries 2 --min-rate 100 
...
# Enumerate LDAP
nmap -n -sV --script ldap-rootdse -p389 -iL alive.txt -o enum-ldap.txt -d --stats-every 30s --max-retries 2 --min-rate 100
$ldap = cat enum-ldap.txt; $ldap >> enum-all.txt

# Enumerate DNS
nmap -n -sV --script "dns-zone-transfer,dns-update,dns-srv-enum,dns-service-discovery,dns-nsid,dns-nsec-enum,dns-nsec3-enum" -p53 -iL alive.txt -o enum-dns.txt -d --stats-every 30s --max-retries 2 --min-rate 100
...
$ports = cat ports.txt
nmap -n -A -sV --script vulners -p $ports -iL alive.txt -oA vulners-alive -d --stats-every 30s --max-retries 2 --min-rate 100

nmap-parse-output vulners-alive html-bootstrap > vulners-alive.html

# # Vuln scan with nmap vuln
# To catch what we didnt get with the first scan
# # Scan for score 4 and above targeted at different services. Lets see how this goes.
# # nmap -n -Pn -sV --script "smb-vuln-conficker.nse,smb-vuln-cve2009-3103.nse,smb-vuln-cve-2017-7494.nse,smb-vuln-ms06-025.nse,smb-vuln-ms07-029.nse,smb-vuln-ms08-067.nse,smb-vuln-ms10-054.nse,smb-vuln-ms10-061.nse,smb-vuln-ms17-010.nse,smb-vuln-regsvc-dos.nse,smb-vuln-webexec.nse,smb-webexec-exploit.nse,smb2-vuln-uptime.nse,smb2-security-mode.nse" -p445 -iL smb.txt -oA vuln-smb-cve -d --stats-every 30s --max-retries 2 --min-rate 100
# nmap -n -Pn -sV --script vuln --script-args mincvss=4 -p "445,139" -iL smb.txt -oA vuln-smb -d --stats-every 30s --max-retries 2 --min-rate 100
# nmap -n -Pn -sV --script vuln --script-args mincvss=4 -iL http-ports.txt -oA vuln-http-ports -d --stats-every 30s --max-retries 2 --min-rate 100
# nmap -n -Pn -sV --script vuln --script-args mincvss=4 -p135 -iL msrpc.txt -oA vuln-msrpc -d --stats-every 30s --max-retries 2 --min-rate 100
# nmap -n -Pn -sV --script vuln --script-args mincvss=4 -p22 -iL ssh.txt -oA vuln-ssh -d --stats-every 30s --max-retries 2 --min-rate 100
# nmap -n -Pn -sV --script vuln --script-args mincvss=4 -p21 -iL ftp.txt -oA vuln-ftp -d --stats-every 30s --max-retries 2 --min-rate 100
# nmap -n -Pn -sV --script vuln --script-args mincvss=4 -p23 -iL telnet.txt -oA vuln-telnet -d --stats-every 30s --max-retries 2 --min-rate 100
# nmap -n -Pn -sV --script vuln --script-args mincvss=4 -iL smtp.txt -oA vuln-smtp -d --stats-every 30s --max-retries 2 --min-rate 100
# nmap -n -Pn -sV --script vuln --script-args mincvss=4 -iL snmp.txt -oA vuln-snmp -d --stats-every 30s --max-retries 2 --min-rate 100
# nmap -n -Pn -sV --script vuln --script-args mincvss=4 -p3306 -iL mysql.txt -oA vuln-mysql -d --stats-every 30s --max-retries 2 --min-rate 100
# nmap -n -Pn -sV --script vuln --script-args mincvss=4 -p "5432,5433" -iL postgresql.txt -oA vuln-postgresql -d --stats-every 30s --max-retries 2 --min-rate 100
# nmap -n -Pn -sV --script vuln --script-args mincvss=4 -p "1583,3351,3352" -iL psql.txt -oA vuln-psql -d --stats-every 30s --max-retries 2 --min-rate 100
# nmap -n -Pn -sUV --script vuln --script-args mincvss=4 -p "1432-1434" -iL mssql.txt -oA vuln-mssql -d --stats-every 30s --max-retries 2 --min-rate 100
# nmap -n -Pn -sV --script vuln --script-args mincvss=4 -p88 -iL kerberos.txt -oA vuln-kerberos -d --stats-every 30s --max-retries 2 --min-rate 100
# nmap -n -Pn -sV --script vuln --script-args mincvss=4 -p53 -iL dns.txt -oA vuln-dns -d --stats-every 30s --max-retries 2 --min-rate 100
...
# # UDP discovery scans
# nmap -sU –top-ports 100 -iL alive.txt -oX udp-top --max-retries 2 -d --stats-every 30s --max-retries 2 --min-rate 100
# nmap -sUV –top-ports 100 -iL alive.txt -oX udp-top-services --max-retries 2 -d --stats-every 30s --max-retries 2 --min-rate 100
...
# nmap -sTUV –top-ports 200 -iL alive.txt -oX udp-mixed-top200 -d --stats-every 30s --max-retries 2 --min-rate 100

# removed the -Pn, add back if its slow I guess
# nmap -vv -O -P0 -sTUV –top-ports 1000 -oX udp-mixed-top1000 $test -d --stats-every 30s --max-retries 2 --min-rate 100
# 
